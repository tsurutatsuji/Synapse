    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm space-y-8">
        ...
        <div className="glass-strong rounded-2xl p-8 space-y-6">
          ...
          {/* Google OAuth — 唯一のログイン方法 */}
          {googleAvailable === false ? (
            <div className="space-y-4">
              <div className="w-full flex items-center justify-center gap-3 bg-[#F0EDE5]/20 text-[#A8A49C]/50 font-medium rounded-full py-3.5 px-4 cursor-not-allowed">
              ...
              <p className="text-center text-xs text-[#A8A49C]/30">
                管理者が Google OAuth を設定するまでお待ちください。
              </p>
            </div>
          ) : (
            <button
          ...
          <p className="text-center text-xs text-[#A8A49C]/30 leading-relaxed">
